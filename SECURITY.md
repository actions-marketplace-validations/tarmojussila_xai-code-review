...
Use [GitHub's private vulnerability reporting](https://github.com/tarmojussila/xai-code-review/security/advisories/new) to submit a report.
...
- Store your `XAI_API_KEY` exclusively as a [GitHub Actions secret](https://docs.github.com/en/actions/security-guides/using-secrets-in-github-actions) — never as a plain variable or hardcoded in the workflow file.
